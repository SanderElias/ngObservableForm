import { Component, ɵComponentDef as ComponentDef } from "@angular/core";
import {
  getHookObservable,
  LifeCycleHook,
} from "@se-ng/ivy-life-cycle-decorators";
...
export function MakeObservable(): Function {
  return function (
    ...
    const retour = innerSB
      .asObservable()
      .pipe(tap((r) => Promise.resolve().then(() => undefined)));
